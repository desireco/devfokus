...
featured: false
relatedTopics: ['what-is-data-engineering-a-guide-to-building-data-pipelines', 'an-introduction-to-stream-processing']
...
- [An Introduction to Stream Processing with Apache Kafka and Flink](/category/data-engineering/an-introduction-to-stream-processing)
