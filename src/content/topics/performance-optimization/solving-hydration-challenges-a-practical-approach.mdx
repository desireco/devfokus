...
relatedTopics: ['when-should-you-implement-ssr-vs-csr-for-performance', 'frontend-performance-problems-heres-your-solution', 'the-complete-performance-metrics-tutorial', 'building-bundle-size-optimization-from-scratch', 'performance-optimization']
...
- [Implementing React Server Components NextJS]({{/topics/implementing-react-server-components-nextjs}})
