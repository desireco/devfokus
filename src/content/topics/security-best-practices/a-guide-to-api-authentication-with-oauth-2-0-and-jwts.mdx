...
featured: true
relatedTopics: ['preventing-cross-site-request-forgery-csrf-attacks', 'best-practices-for-securely-storing-passwords']
...
- [Preventing Cross-Site Request Forgery (CSRF) Attacks](/category/security-best-practices/preventing-cross-site-request-forgery-csrf-attacks)
