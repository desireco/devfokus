...
relatedTopics:
  [
    ...
    'typescript-api-development-type-safe-backend',
    'typescript-performance-compilation-speed-runtime-optimization',
    'software-design-patterns/solid-design-principles',
...
- [TypeScript API Development: Type-Safe Backend Development](/topics/typescript-api-development-type-safe-backend) - Type-safe APIs

### Design Patterns & Principles
- [SOLID Design Principles](/topics/software-design-patterns/solid-design-principles) - Architectural principles
- [Object-Oriented Design Patterns](/topics/system-design/object-oriented-design-patterns) - Classic patterns
- [JavaScript OOP: Classes and Prototypes](/topics/javascript-object-oriented-programming-classes-prototypes-inheritance) - OOP fundamentals
