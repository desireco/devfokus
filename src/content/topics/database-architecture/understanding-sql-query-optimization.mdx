...
featured: false
relatedTopics: ['database-indexing-best-practices', 'an-introduction-to-database-transactions-and-acid-compliance']
...
- [Database Indexing Best Practices](/category/database-architecture/database-indexing-best-practices)
