...
featured: false
relatedTopics: ['decomposing-a-monolith-into-microservices', 'an-introduction-to-microservices-architecture', 'microservices-communication-patterns', 'integration-testing-frameworks', 'test-automation-cicd-integration', 'contract-testing-with-pact', 'api-testing-automation', 'docker-and-containerization-fundamentals', 'test-driven-development-tdd-best-practices', 'advanced-unit-testing-jest-vitest']
...
- **What they are**: Tests that verify the interaction between your service and its infrastructure dependencies, such as its own database or a message queue. ...in a [Docker container](/devops-cloud/docker-containerization-step-by-step), not a mock.
...
- **Goal**: To ensure that a provider service never makes a change that breaks one of its consumers. ...in the provider's [CI/CD pipeline](/devops/an-introduction-to-cicd).
...
- [Contract Testing with Pact](/topics/contract-testing-with-pact)
