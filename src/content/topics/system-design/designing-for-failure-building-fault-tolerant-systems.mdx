...
featured: true
relatedTopics:
  ['introduction-to-observability-logs-metrics-and-traces', 'understanding-database-replication-a-step-by-step-guide']
...
- [An Introduction to Observability: Logs, Metrics, and Traces](/category/system-design/introduction-to-observability-logs-metrics-and-traces)
