...
featured: false
relatedTopics: ['getting-started-with-apache-spark', 'what-is-data-engineering-a-guide-to-building-data-pipelines']
...
- [Getting Started with Apache Spark: A Guide to Large-Scale Batch Processing](/category/data-engineering/getting-started-with-apache-spark)
