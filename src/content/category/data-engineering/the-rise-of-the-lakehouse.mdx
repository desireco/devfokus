...
featured: true
relatedTopics: ['an-introduction-to-the-modern-data-warehouse', 'what-is-a-data-lake']
...
- [An Introduction to the Modern Data Warehouse](/category/data-engineering/an-introduction-to-the-modern-data-warehouse)
