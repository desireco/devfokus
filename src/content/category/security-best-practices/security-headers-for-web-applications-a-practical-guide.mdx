...
featured: false
relatedTopics: ['content-security-policy-csp', 'understanding-cross-site-scripting-xss-a-guide-to-prevention']
...
- [Content Security Policy (CSP): A Defense Against XSS and Injection Attacks](/category/security-best-practices/content-security-policy-csp)
