...
featured: true
relatedTopics:
  ['javascript-error-handling-patterns', 'javascript-modules-bundling', 'javascript-performance-optimization']
...
- [JavaScript Modules: ES Modules vs CommonJS and Modern Bundling](/topics/javascript-modules-bundling)
